...
@Component({
  selector: 'app-womens-slider',
  templateUrl: './womens-slider.component.html',
  styleUrls: ['./womens-slider.component.scss']
})
export class WomensSliderComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    let categoryId = this.categories.find(cat => cat.CategoryName == "Womens")._id;
